                ...
                <div className="space-y-6">
                  <div className="flex items-start justify-between">
                    <div className="space-y-2">
                      ...
                      <p className="text-green-600 font-medium">{story.organization}</p>
                    </div>
                  ...
                  <button className="flex items-center space-x-2 text-green-600 hover:text-green-700 font-medium group-hover:space-x-3 transition-all">
