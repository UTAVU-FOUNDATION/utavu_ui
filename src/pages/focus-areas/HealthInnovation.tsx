                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="font-semibold text-red-600">{initiative.impact}</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-red-600">{study.metrics.patients}</div>
                      <div className="text-sm text-gray-600">Patients</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-red-600">{study.metrics.providers}</div>
                      <div className="text-sm text-gray-600">Providers</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-red-600">{study.metrics.satisfaction}</div>
